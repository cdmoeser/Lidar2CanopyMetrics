function Lidar2CanopyMetricsAlt
  ...
  %   run Lidar2CanopyMetricsAlt from the command line of Matlab
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  for coordidx = 1:length(coordinate_database(:,1));                       % loop through coordinates of evaluation points
    ...
    xlim                = [x_coor-ev_offs,x_coor+ev_offs];                 % defines rectangular evaluation domain
    ylim                = [y_coor-ev_offs,y_coor+ev_offs];                 % defines rectangular evaluation domain
